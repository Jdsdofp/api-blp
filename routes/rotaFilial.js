...
const { registrarFilial, listarFiliais, listarFilial, listarEmpresaComFiliais } = require("../controllers/filialController");
...
fililRoute.get('/:e_id/listar-empresas-filiais', listarEmpresaComFiliais)
